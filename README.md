...
# PLUGIN STILL IN DEVELOPMENT. DO NOT DOWNLOAD IT YET.
...
- Stepped gradient layers for stylized falloff
- Shared texture caching across instances with the same settings
